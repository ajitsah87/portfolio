...
function About() {
  ...
  return (
    <>
      <div id="/about" className="mx-auto w-[75%] border-[2px] border-neutral-800 rounded-[5px] bg-[#151515]  px-6 py-6 flex items-center justify-between mb-[15rem]">
        <div className=" w-1/2 ">
          <img className="" src="me.svg" alt="img" />
        </div>
        <div className="w-[55%] ">
          <h2 className="text-[#986dff] text-[1.5rem] font-medium">About Me</h2>{" "}
          <br />
          <h1 className="text-white text-[3rem]">Ajit Sah</h1> <br />
